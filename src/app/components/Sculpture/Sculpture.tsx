    ...
    return (
        <div className="work-section-container sculpture">
            <div className="info-container">
                <span className="title">Taille de pierre et sculpture</span>
                ...
                <span className="section-button" onClick={() => navigateToPage('Cutting')}>Voir plus</span>
            </div>
            <div className="image-container">
                <img src="/assets/image-3.jpg" alt="sculpture image"/>
            </div>
        </div>
    );
};
